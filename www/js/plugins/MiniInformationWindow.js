        ...
        switch (e.code) {
          case 11:
            if (e.value1 > 0 && effectNames[0])
              text =
                s + effectNames[0] + ":" + g + Math.floor(e.value1 * 100) + "%";
            ...
            if (e.value2 > 0 && effectNames[0])
              text = s + effectNames[0] + ":" + g + e.value2;
            if (e.value2 < 0 && effectNames[1])
              text = s + effectNames[1] + ":" + r + Math.abs(e.value2);
            break;
          case 12:
            if (e.value1 > 0 && effectNames[2])
              text =
                s + effectNames[2] + ":" + g + Math.floor(e.value1 * 100) + "%";
            ...
            if (e.value2 > 0 && effectNames[2])
              text = s + effectNames[2] + ":" + g + e.value2;
            if (e.value2 < 0 && effectNames[3])
              text = s + effectNames[3] + ":" + r + Math.abs(e.value2);
            break;
          case 13:
            if (e.value1 > 0 && effectNames[4])
              text = s + effectNames[4] + g + "+" + e.value1;
            break;
          case 21:
          ...
          case 31:
            ...
            if (e.value1 > 0 && effectNames[7])
              text =
                s + effectNames[7] + ":" + c + name + " " + e.value1 + turnText;
            break;
          case 32:
            var name = TextManager.param(e.dataId);
            if (e.value1 > 0 && effectNames[8])
              text =
                s + effectNames[8] + ":" + c + name + " " + e.value1 + turnText;
            break;
          case 33:
            if (effectNames[9]) {
              var name = TextManager.param(e.dataId);
          ...
          case 41:
            if (effectNames[11])
              text = s + effectNames[11] + ":" + c + escapeText;
            break;
          case 42:
            if (effectNames[12]) {
              var name = TextManager.param(e.dataId);
        ...
        switch (trait.code) {
          ...
          case 61:
            if (vocab[6][0] && value > 0)
              text = s + vocab[6][0] + du + sym + value * 100 + "%";
            break;
          case 62:
            if (vocab[6][1 + dataId]) {

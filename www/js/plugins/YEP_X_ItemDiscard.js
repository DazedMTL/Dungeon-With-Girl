...
if (
  ...
  Yanfly.Param.ItemDiscardDefault = String(
    Yanfly.Parameters["Default Discard"]
  );
  Yanfly.Param.ItemDiscardDefault = eval(Yanfly.Param.ItemDiscardDefault);
  Yanfly.Param.ItemDiscardConfirm = String(
    Yanfly.Parameters["Confirm Discard"]
  );
  Yanfly.Param.ItemDiscardConfirm = eval(Yanfly.Param.ItemDiscardConfirm);
  Yanfly.Param.ItemDiscardMessage = String(
    Yanfly.Parameters["Confirm Message"]
  );
  ...
  Yanfly.ItemDiscard.DataManager_isDatabaseLoaded =
    DataManager.isDatabaseLoaded;
  DataManager.isDatabaseLoaded = function () {
    if (!Yanfly.ItemDiscard.DataManager_isDatabaseLoaded.call(this))
      return false;

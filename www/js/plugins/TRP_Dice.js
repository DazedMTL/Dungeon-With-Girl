...
(function () {
  ...
  Game_Dice.prototype.processCommand = function (args) {
    ...
    if (!isNaN(args[i])) {
      throwError(
        "ダイスコマンドの２番目のパラメータはサブコマンド名を指定してください。"
      );
    }
  ...
  Game_Dice.prototype.canPlaySe = function (disableFrame) {
    return (
      this.seCount >= Game_Dice.SE_COUNT_STARTED && this.seCount < disableFrame
    );
  };
  ...
  Game_Dice.prototype.checkerError = function () {
    if (!this._checker) {
      throw new Error(
        "分析結果がありません。「ダイス 統計 開始 ダイスID1 ダイスID2 ...」コマンドで分析を行ってください。"
      );
    }
  };
  ...
  var _tempArray = [];
  Dice.prototype._setupRotation = function (
    rolling,
    typeSetting,
    motionSetting
  ) {
  ...
  Scene_Base.prototype.rearrangeDiceContainerLayer = function () {
    ...
    switch (layer) {
      case LAYER.behindPicture:
        ...
        index = spriteset
          ? this._spriteset.children.indexOf(this._spriteset._pictureContainer)
          : -1;
        if (index < 0) {
          this.addChild(container);
        } else {
  ...
  Sprite_Dice.prototype.refreshBitmap = function (dice) {
    ...
    var bitmap = Sprite_Dice.loadBitmap(
      dice.imageName,
      this._planeNum,
      this._value
    );
  ...
  Game_Interpreter.prototype.trpDiceTest = function () {
    ...
    var list = [
      ...
      { code: 401, indent: 0, parameters: ["\\C[2]賭博師\\C[0]"] },
      { code: 401, indent: 0, parameters: ["チンチロリンで勝負しようぜ！"] },
      {
        code: 102,
        indent: 0,
        parameters: [
      ...
      { code: 402, indent: 0, parameters: [0, "掛け金100\\Gで勝負"] },
      { code: 122, indent: 1, parameters: [11, 11, 0, 0, 100] },
      { code: 101, indent: 1, parameters: ["", 0, 0, 2] },
      { code: 401, indent: 1, parameters: ["\\C[2]gambler\\C[0]"] },
      { code: 401, indent: 1, parameters: ["よっしゃ、勝負だぜ！"] },
      { code: 0, indent: 1, parameters: [] },
      { code: 402, indent: 0, parameters: [1, "掛け金500\\Gで勝負"] },
      { code: 122, indent: 1, parameters: [11, 11, 0, 0, 500] },
      { code: 101, indent: 1, parameters: ["", 0, 0, 2] },
      { code: 401, indent: 1, parameters: ["\\C[2]賭博師\\C[0]"] },
      { code: 401, indent: 1, parameters: ["おっ、景気良さそうだな！"] },
      { code: 0, indent: 1, parameters: [] },
      { code: 402, indent: 0, parameters: [2, "掛け金2000\\Gで勝負"] },
      { code: 122, indent: 1, parameters: [11, 11, 0, 0, 2000] },
      { code: 101, indent: 1, parameters: ["", 0, 0, 2] },
      { code: 401, indent: 1, parameters: ["\\C[2]賭博師\\C[0]"] },
      { code: 401, indent: 1, parameters: ["しょ、勝負に出たな・・・！"] },
      { code: 401, indent: 1, parameters: ["負けられねーぜ！"] },
      { code: 0, indent: 1, parameters: [] },
      { code: 402, indent: 0, parameters: [3, "いいえ"] },
      { code: 101, indent: 1, parameters: ["", 0, 0, 2] },
      { code: 401, indent: 1, parameters: ["\\C[2]賭博師\\C[0]"] },
      { code: 401, indent: 1, parameters: ["けっ、つまんねぇ奴だぜ。"] },
      { code: 115, indent: 1, parameters: [] },
      { code: 0, indent: 1, parameters: [] },
      { code: 404, indent: 0, parameters: [] },
      { code: 122, indent: 0, parameters: [13, 13, 0, 1, 11] },
      { code: 122, indent: 0, parameters: [13, 13, 3, 0, 4] },
      { code: 122, indent: 0, parameters: [12, 12, 0, 3, 7, 2, 0] },
      { code: 111, indent: 0, parameters: [1, 12, 1, 13, 4] },
      { code: 101, indent: 1, parameters: ["", 0, 0, 2] },
      { code: 401, indent: 1, parameters: ["\\C[2]賭博師\\C[0]"] },
      {
        code: 401,
        indent: 1,
        parameters: ["・・・おいおい、最低でも掛け金の４倍、"],
      },
      {
        code: 401,
        indent: 1,
        parameters: ["\\V[13]\\Gは持ってないと勝負は受けられねーぜ。"],
      },
      { code: 115, indent: 1, parameters: [] },
      { code: 0, indent: 1, parameters: [] },
      { code: 412, indent: 0, parameters: [] },
      { code: 122, indent: 0, parameters: [10, 10, 0, 0, 150] },
      { code: 223, indent: 0, parameters: [[-150, -150, -150, 0], 30, true] },
      { code: 356, indent: 0, parameters: ["ダイス クリア 全て"] },
      { code: 356, indent: 0, parameters: ["ダイス 変数 1 2"] },
      { code: 356, indent: 0, parameters: ["ダイス 変数 2 3"] },
      { code: 356, indent: 0, parameters: ["ダイス タイプ 1 チンチロ自分"] },
      { code: 356, indent: 0, parameters: ["ダイス タイプ 2 チンチロ相手"] },
      { code: 112, indent: 0, parameters: [] },
      { code: 356, indent: 1, parameters: ["ダイス 表示 1 308 \\V[10]"] },
      { code: 356, indent: 1, parameters: ["ダイス ランダムロール 1"] },
      { code: 356, indent: 1, parameters: ["ダイス 表示 2 508 \\V[10]"] },
      { code: 356, indent: 1, parameters: ["ダイス ランダムロール 2"] },
      { code: 356, indent: 1, parameters: ["ダイス ウェイト"] },
      { code: 111, indent: 1, parameters: [1, 2, 1, 3, 5] },
      ...
      { code: 111, indent: 0, parameters: [1, 2, 1, 3, 3] },
      { code: 121, indent: 1, parameters: [2, 2, 0] },
      { code: 0, indent: 1, parameters: [] },
      { code: 411, indent: 0, parameters: [] },
      { code: 121, indent: 1, parameters: [2, 2, 1] },
      { code: 0, indent: 1, parameters: [] },
      { code: 412, indent: 0, parameters: [] },
      { code: 121, indent: 0, parameters: [3, 3, 1] },
      { code: 121, indent: 0, parameters: [4, 4, 1] },
      { code: 121, indent: 0, parameters: [6, 6, 1] },
      { code: 122, indent: 0, parameters: [14, 14, 0, 0, 0] },
      { code: 112, indent: 0, parameters: [] },
      { code: 230, indent: 1, parameters: [10] },
      { code: 111, indent: 1, parameters: [0, 2, 0] },
      { code: 111, indent: 2, parameters: [0, 6, 0] },
      {
        code: 231,
        indent: 3,
        parameters: [1, "your_turn_continue", 1, 0, 508, 212, 130, 0, 0, 0],
      },
      ...
      { code: 411, indent: 2, parameters: [] },
      {
        code: 231,
        indent: 3,
        parameters: [1, "your_turn", 1, 0, 508, 212, 130, 0, 0, 0],
      },
      { code: 0, indent: 3, parameters: [] },
      ...
      { code: 111, indent: 2, parameters: [0, 6, 0] },
      {
        code: 231,
        indent: 3,
        parameters: [1, "enemy_turn_continue", 1, 0, 508, 212, 130, 0, 0, 0],
      },
      { code: 0, indent: 3, parameters: [] },
      { code: 411, indent: 2, parameters: [] },
      {
        code: 231,
        indent: 3,
        parameters: [1, "enemy_turn", 1, 0, 508, 212, 130, 0, 0, 0],
      },
      { code: 0, indent: 3, parameters: [] },
      { code: 412, indent: 2, parameters: [] },
      { code: 0, indent: 2, parameters: [] },
      { code: 412, indent: 1, parameters: [] },
      {
        code: 250,
        indent: 1,
        parameters: [{ name: "Attack2", volume: 90, pitch: 100, pan: 0 }],
      },
      {
        code: 232,
        indent: 1,
        parameters: [1, 0, 1, 0, 413, 212, 100, 100, 255, 0, 6, true],
      },
      {
        code: 232,
        indent: 1,
        parameters: [1, 0, 1, 0, 403, 212, 100, 100, 255, 0, 45, true],
      },
      {
        code: 232,
        indent: 1,
        parameters: [1, 0, 1, 0, 358, 212, 130, 0, 0, 0, 8, true],
      },
      { code: 235, indent: 1, parameters: [1] },
      { code: 356, indent: 1, parameters: ["ダイス 非表示 1 10"] },
      { code: 356, indent: 1, parameters: ["ダイス 非表示 2 10"] },
      { code: 356, indent: 1, parameters: ["ダイス 非表示 3 10"] },
      { code: 356, indent: 1, parameters: ["ダイス 非表示 4 10"] },
      { code: 356, indent: 1, parameters: ["ダイス 非表示 5 10"] },
      { code: 356, indent: 1, parameters: ["ダイス 非表示 6 10"] },
      { code: 356, indent: 1, parameters: ["ダイス 変数 1 2"] },
      { code: 356, indent: 1, parameters: ["ダイス 変数 2 3"] },
      { code: 356, indent: 1, parameters: ["ダイス 変数 3 4"] },
      { code: 356, indent: 1, parameters: ["ダイス 変数 4 5"] },
      { code: 356, indent: 1, parameters: ["ダイス 変数 5 6"] },
      { code: 356, indent: 1, parameters: ["ダイス 変数 6 7"] },
      { code: 230, indent: 1, parameters: [10] },
      { code: 356, indent: 1, parameters: ["ダイス クリア 1"] },
      { code: 356, indent: 1, parameters: ["ダイス クリア 2"] },
      { code: 356, indent: 1, parameters: ["ダイス クリア 3"] },
      { code: 356, indent: 1, parameters: ["ダイス クリア 4"] },
      { code: 356, indent: 1, parameters: ["ダイス クリア 5"] },
      { code: 356, indent: 1, parameters: ["ダイス クリア 6"] },
      { code: 356, indent: 1, parameters: ["ダイス タイプ 1 チンチロ自分"] },
      { code: 356, indent: 1, parameters: ["ダイス タイプ 2 チンチロ自分"] },
      { code: 356, indent: 1, parameters: ["ダイス タイプ 3 チンチロ自分"] },
      { code: 356, indent: 1, parameters: ["ダイス タイプ 4 チンチロ相手"] },
      { code: 356, indent: 1, parameters: ["ダイス タイプ 5 チンチロ相手"] },
      { code: 356, indent: 1, parameters: ["ダイス タイプ 6 チンチロ相手"] },
      { code: 121, indent: 1, parameters: [5, 5, 0] },
      { code: 122, indent: 1, parameters: [19, 19, 0, 0, 0] },
      { code: 112, indent: 1, parameters: [] },
      { code: 122, indent: 2, parameters: [19, 19, 1, 0, 1] },
      { code: 111, indent: 2, parameters: [0, 2, 0] },
      { code: 121, indent: 3, parameters: [7, 7, 0] },
      { code: 112, indent: 3, parameters: [] },
      { code: 111, indent: 4, parameters: [11, "ok"] },
      { code: 113, indent: 5, parameters: [] },
      { code: 0, indent: 5, parameters: [] },
      { code: 412, indent: 4, parameters: [] },
      { code: 111, indent: 4, parameters: [12, "TouchInput.isTriggered()"] },
      { code: 113, indent: 5, parameters: [] },
      { code: 0, indent: 5, parameters: [] },
      { code: 412, indent: 4, parameters: [] },
      { code: 230, indent: 4, parameters: [1] },
      { code: 0, indent: 4, parameters: [] },
      { code: 413, indent: 3, parameters: [] },
      { code: 121, indent: 3, parameters: [7, 7, 1] },
      {
        code: 232,
        indent: 3,
        parameters: [1, 0, 1, 0, 408, 452, 100, 100, 0, 0, 30, false],
      },
      { code: 356, indent: 3, parameters: ["ダイス 表示 1 308 \\V[10]"] },
      { code: 356, indent: 3, parameters: ["ダイス 表示 2 408 \\V[10]"] },
      { code: 356, indent: 3, parameters: ["ダイス 表示 3 508 \\V[10]"] },
      { code: 356, indent: 3, parameters: ["ダイス ランダムロール 1"] },
      { code: 356, indent: 3, parameters: ["ダイス ランダムロール 2"] },
      { code: 356, indent: 3, parameters: ["ダイス ランダムロール 3"] },
      { code: 356, indent: 3, parameters: ["ダイス 統計 開始 1 2 3"] },
      { code: 0, indent: 3, parameters: [] },
      { code: 411, indent: 2, parameters: [] },
      { code: 356, indent: 3, parameters: ["ダイス 表示 4 308 \\V[10]"] },
      { code: 356, indent: 3, parameters: ["ダイス 表示 5 408 \\V[10]"] },
      { code: 356, indent: 3, parameters: ["ダイス 表示 6 508 \\V[10]"] },
      { code: 356, indent: 3, parameters: ["ダイス ランダムロール 4"] },
      { code: 356, indent: 3, parameters: ["ダイス ランダムロール 5"] },
      { code: 356, indent: 3, parameters: ["ダイス ランダムロール 6"] },
      { code: 356, indent: 3, parameters: ["ダイス 統計 開始 4 5 6"] },
      { code: 0, indent: 3, parameters: [] },
      { code: 412, indent: 2, parameters: [] },
      { code: 356, indent: 2, parameters: ["ダイス ウェイト"] },
      { code: 230, indent: 2, parameters: [30] },
      { code: 356, indent: 2, parameters: ["dice checker maxPair 24"] },
      { code: 356, indent: 2, parameters: ["dice checker maxPairNum 25"] },
      { code: 356, indent: 2, parameters: ["dice checker total 26"] },
      { code: 356, indent: 2, parameters: ["dice checker straight 27"] },
      { code: 122, indent: 2, parameters: [22, 22, 0, 0, 0] },
      { code: 111, indent: 2, parameters: [1, 24, 0, 2, 0] },
      { code: 122, indent: 3, parameters: [22, 22, 0, 0, 1] },
      { code: 122, indent: 3, parameters: [23, 23, 0, 1, 26] },
      { code: 122, indent: 3, parameters: [23, 23, 2, 1, 25] },
      { code: 122, indent: 3, parameters: [23, 23, 2, 1, 25] },
      { code: 0, indent: 3, parameters: [] },
      { code: 412, indent: 2, parameters: [] },
      { code: 111, indent: 2, parameters: [1, 24, 0, 3, 0] },
      { code: 111, indent: 3, parameters: [1, 25, 0, 1, 0] },
      { code: 122, indent: 4, parameters: [22, 22, 0, 0, 3] },
      { code: 0, indent: 4, parameters: [] },
      { code: 411, indent: 3, parameters: [] },
      { code: 122, indent: 4, parameters: [22, 22, 0, 0, 2] },
      { code: 0, indent: 4, parameters: [] },
      { code: 412, indent: 3, parameters: [] },
      { code: 122, indent: 3, parameters: [23, 23, 0, 1, 25] },
      { code: 0, indent: 3, parameters: [] },
      { code: 412, indent: 2, parameters: [] },
      { code: 111, indent: 2, parameters: [1, 27, 0, 1, 0] },
      { code: 122, indent: 3, parameters: [22, 22, 0, 0, 4] },
      { code: 0, indent: 3, parameters: [] },
      { code: 412, indent: 2, parameters: [] },
      { code: 111, indent: 2, parameters: [1, 27, 0, 4, 0] },
      { code: 122, indent: 3, parameters: [22, 22, 0, 0, 5] },
      { code: 0, indent: 3, parameters: [] },
      { code: 412, indent: 2, parameters: [] },
      { code: 111, indent: 2, parameters: [1, 22, 0, 0, 5] },
      { code: 113, indent: 3, parameters: [] },
      { code: 0, indent: 3, parameters: [] },
      { code: 412, indent: 2, parameters: [] },
      { code: 111, indent: 2, parameters: [1, 19, 0, 3, 0] },
      { code: 113, indent: 3, parameters: [] },
      { code: 0, indent: 3, parameters: [] },
      { code: 412, indent: 2, parameters: [] },
      { code: 0, indent: 2, parameters: [] },
      { code: 413, indent: 1, parameters: [] },
      { code: 122, indent: 1, parameters: [16, 16, 0, 1, 22] },
      { code: 122, indent: 1, parameters: [17, 17, 0, 1, 23] },
      { code: 112, indent: 1, parameters: [] },
      { code: 111, indent: 2, parameters: [1, 22, 0, 1, 0] },
      { code: 111, indent: 3, parameters: [0, 5, 0] },
      { code: 111, indent: 4, parameters: [1, 23, 0, 1, 0] },
      {
        code: 231,
        indent: 5,
        parameters: [1, "hand_parent_1", 1, 0, 408, 212, 800, 800, 0, 0],
      },
      {
        code: 250,
        indent: 5,
        parameters: [{ name: "Collapse3", volume: 90, pitch: 100, pan: 0 }],
      },
      {
        code: 232,
        indent: 5,
        parameters: [1, 0, 1, 0, 408, 212, 105, 105, 255, 0, 8, true],
      },
      {
        code: 232,
        indent: 5,
        parameters: [1, 0, 1, 0, 408, 212, 100, 100, 255, 0, 60, true],
      },
      {
        code: 232,
        indent: 5,
        parameters: [1, 0, 1, 0, 408, 212, 130, 0, 255, 0, 6, true],
      },
      { code: 235, indent: 5, parameters: [1] },
      { code: 113, indent: 5, parameters: [] },
      { code: 0, indent: 5, parameters: [] },
      { code: 412, indent: 4, parameters: [] },
      { code: 111, indent: 4, parameters: [1, 23, 0, 6, 0] },
      {
        code: 231,
        indent: 5,
        parameters: [1, "hand_parent_6", 1, 0, 408, 212, 800, 800, 0, 0],
      },
      {
        code: 250,
        indent: 5,
      ...
      { code: 0, indent: 4, parameters: [] },
      { code: 412, indent: 3, parameters: [] },
      { code: 111, indent: 3, parameters: [1, 23, 0, 1, 0] },
      {
        code: 231,
        indent: 4,
        parameters: [1, "hand_1", 1, 0, 508, 212, 130, 0, 0, 0],
      },
      {
        code: 250,
        indent: 4,
      ...
      { code: 235, indent: 4, parameters: [1] },
      { code: 113, indent: 4, parameters: [] },
      { code: 0, indent: 4, parameters: [] },
      { code: 412, indent: 3, parameters: [] },
      { code: 111, indent: 3, parameters: [1, 23, 0, 2, 0] },
      {
        code: 231,
        indent: 4,
        parameters: [1, "hand_2", 1, 0, 508, 212, 130, 0, 0, 0],
      },
      {
        code: 250,
        indent: 4,
      ...
      { code: 0, indent: 4, parameters: [] },
      { code: 412, indent: 3, parameters: [] },
      { code: 111, indent: 3, parameters: [1, 23, 0, 3, 0] },
      {
        code: 231,
        indent: 4,
        parameters: [1, "hand_3", 1, 0, 508, 212, 130, 0, 0, 0],
      },
      {
        code: 250,
        indent: 4,
      ...
      { code: 0, indent: 4, parameters: [] },
      { code: 412, indent: 3, parameters: [] },
      { code: 111, indent: 3, parameters: [1, 23, 0, 4, 0] },
      {
        code: 231,
        indent: 4,
        parameters: [1, "hand_4", 1, 0, 508, 212, 130, 0, 0, 0],
      },
      {
        code: 250,
        indent: 4,
      ...
      { code: 0, indent: 4, parameters: [] },
      { code: 412, indent: 3, parameters: [] },
      { code: 111, indent: 3, parameters: [1, 23, 0, 5, 0] },
      {
        code: 231,
        indent: 4,
        parameters: [1, "hand_5", 1, 0, 508, 212, 130, 0, 0, 0],
      },
      {
        code: 250,
        indent: 4,
      ...
      { code: 0, indent: 4, parameters: [] },
      { code: 412, indent: 3, parameters: [] },
      { code: 111, indent: 3, parameters: [1, 23, 0, 6, 0] },
      {
        code: 231,
        indent: 4,
        parameters: [1, "hand_6", 1, 0, 508, 212, 130, 0, 0, 0],
      },
      {
        code: 250,
        indent: 4,
      ...
      { code: 0, indent: 3, parameters: [] },
      { code: 412, indent: 2, parameters: [] },
      { code: 111, indent: 2, parameters: [1, 22, 0, 2, 0] },
      {
        code: 231,
        indent: 3,
        parameters: [1, "hand_arashi", 1, 0, 408, 212, 800, 800, 0, 0],
      },
      {
        code: 250,
        indent: 3,
      ...
      { code: 235, indent: 3, parameters: [1] },
      { code: 113, indent: 3, parameters: [] },
      { code: 0, indent: 3, parameters: [] },
      { code: 412, indent: 2, parameters: [] },
      { code: 111, indent: 2, parameters: [1, 22, 0, 3, 0] },
      {
        code: 250,
        indent: 3,
        parameters: [{ name: "Collapse3", volume: 90, pitch: 100, pan: 0 }],
      },
      {
        code: 231,
        indent: 3,
        parameters: [1, "hand_pinzoro", 1, 0, 408, 212, 800, 800, 0, 0],
      },
      {
        code: 232,
        indent: 3,
        parameters: [1, 0, 1, 0, 408, 212, 105, 105, 255, 0, 8, false],
      },
      { code: 230, indent: 3, parameters: [3] },
      {
        code: 231,
        indent: 3,
        parameters: [2, "hand_pinzoro", 1, 0, 408, 212, 800, 800, 0, 0],
      },
      {
        code: 232,
        indent: 3,
        parameters: [2, 0, 1, 0, 408, 212, 105, 105, 255, 0, 8, false],
      },
      { code: 230, indent: 3, parameters: [5] },
      {
        code: 232,
        indent: 3,
        parameters: [1, 0, 1, 0, 408, 212, 100, 100, 255, 0, 60, false],
      },
      { code: 230, indent: 3, parameters: [3] },
      {
        code: 232,
        indent: 3,
        parameters: [2, 0, 1, 0, 408, 212, 100, 100, 0, 0, 60, false],
      },
      { code: 230, indent: 3, parameters: [58] },
      {
        code: 232,
        indent: 3,
        parameters: [1, 0, 1, 0, 408, 212, 130, 0, 255, 0, 6, true],
      ...
      { code: 235, indent: 3, parameters: [1] },
      { code: 235, indent: 3, parameters: [2] },
      { code: 113, indent: 3, parameters: [] },
      { code: 0, indent: 3, parameters: [] },
      { code: 412, indent: 2, parameters: [] },
      { code: 111, indent: 2, parameters: [1, 22, 0, 4, 0] },
      {
        code: 231,
        indent: 3,
        parameters: [1, "hand_hihumi", 1, 0, 408, 212, 800, 800, 0, 0],
      },
      {
        code: 250,
        indent: 3,
      ...
      { code: 0, indent: 3, parameters: [] },
      { code: 412, indent: 2, parameters: [] },
      { code: 111, indent: 2, parameters: [1, 22, 0, 5, 0] },
      {
        code: 231,
        indent: 3,
        parameters: [1, "hand_shigoro", 1, 0, 408, 212, 800, 800, 0, 0],
      },
      {
        code: 250,
        indent: 3,
      ...
      { code: 412, indent: 2, parameters: [] },
      {
        code: 231,
        indent: 2,
        parameters: [1, "hand_none", 1, 0, 508, 212, 130, 0, 0, 0],
      },
      {
        code: 250,
        indent: 2,
      ...
      { code: 0, indent: 2, parameters: [] },
      { code: 413, indent: 1, parameters: [] },
      { code: 122, indent: 1, parameters: [18, 18, 0, 0, 0] },
      { code: 111, indent: 1, parameters: [1, 22, 0, 1, 0] },
      { code: 111, indent: 2, parameters: [1, 17, 0, 1, 0] },
      { code: 122, indent: 3, parameters: [18, 18, 0, 0, -1] },
      { code: 0, indent: 3, parameters: [] },
      { code: 412, indent: 2, parameters: [] },
      { code: 111, indent: 2, parameters: [1, 17, 0, 6, 0] },
      { code: 122, indent: 3, parameters: [18, 18, 0, 0, 1] },
      { code: 0, indent: 3, parameters: [] },
      { code: 412, indent: 2, parameters: [] },
      { code: 0, indent: 2, parameters: [] },
      { code: 412, indent: 1, parameters: [] },
      { code: 111, indent: 1, parameters: [1, 22, 0, 2, 0] },
      { code: 122, indent: 2, parameters: [18, 18, 0, 0, 3] },
      { code: 0, indent: 2, parameters: [] },
      { code: 412, indent: 1, parameters: [] },
      { code: 111, indent: 1, parameters: [1, 22, 0, 3, 0] },
      { code: 122, indent: 2, parameters: [18, 18, 0, 0, 5] },
      { code: 0, indent: 2, parameters: [] },
      { code: 412, indent: 1, parameters: [] },
      { code: 111, indent: 1, parameters: [1, 22, 0, 4, 0] },
      { code: 122, indent: 2, parameters: [18, 18, 0, 0, -2] },
      { code: 0, indent: 2, parameters: [] },
      { code: 412, indent: 1, parameters: [] },
      { code: 111, indent: 1, parameters: [1, 22, 0, 5, 0] },
      { code: 122, indent: 2, parameters: [18, 18, 0, 0, 2] },
      { code: 0, indent: 2, parameters: [] },
      { code: 412, indent: 1, parameters: [] },
      { code: 111, indent: 1, parameters: [1, 18, 0, 0, 5] },
      { code: 119, indent: 2, parameters: ["親番の終了"] },
      { code: 0, indent: 2, parameters: [] },
      { code: 412, indent: 1, parameters: [] },
      { code: 111, indent: 1, parameters: [0, 2, 0] },
      { code: 356, indent: 2, parameters: ["ダイス 移動 1 50 \\V[10] 30"] },
      { code: 356, indent: 2, parameters: ["ダイス 移動 2 100 \\V[10] 30"] },
      { code: 356, indent: 2, parameters: ["ダイス 移動 3 150 \\V[10] 30"] },
      { code: 356, indent: 2, parameters: ["ダイス 拡大 1 80 20"] },
      { code: 356, indent: 2, parameters: ["ダイス 拡大 2 80 20"] },
      { code: 356, indent: 2, parameters: ["ダイス 拡大 3 80 20"] },
      { code: 0, indent: 2, parameters: [] },
      { code: 411, indent: 1, parameters: [] },
      { code: 356, indent: 2, parameters: ["ダイス 移動 4 666 \\V[10] 30"] },
      { code: 356, indent: 2, parameters: ["ダイス 移動 5 716 \\V[10] 30"] },
      { code: 356, indent: 2, parameters: ["ダイス 移動 6 766 \\V[10] 30"] },
      { code: 356, indent: 2, parameters: ["ダイス 拡大 4 80 30"] },
      { code: 356, indent: 2, parameters: ["ダイス 拡大 5 80 30"] },
      { code: 356, indent: 2, parameters: ["ダイス 拡大 6 80 30"] },
      { code: 0, indent: 2, parameters: [] },
      { code: 412, indent: 1, parameters: [] },
      { code: 121, indent: 1, parameters: [5, 5, 1] },
      { code: 111, indent: 1, parameters: [0, 2, 1] },
      {
        code: 231,
        indent: 2,
        parameters: [1, "yout_turn_child", 1, 0, 508, 212, 130, 0, 0, 0],
      },
      { code: 0, indent: 2, parameters: [] },
      { code: 411, indent: 1, parameters: [] },
      {
        code: 231,
        indent: 2,
        parameters: [1, "enemy_turn_child", 1, 0, 508, 212, 130, 0, 0, 0],
      },
      { code: 0, indent: 2, parameters: [] },
      { code: 412, indent: 1, parameters: [] },
      {
      ...
      { code: 112, indent: 1, parameters: [] },
      { code: 122, indent: 2, parameters: [19, 19, 1, 0, 1] },
      { code: 111, indent: 2, parameters: [0, 2, 1] },
      { code: 121, indent: 3, parameters: [7, 7, 0] },
      { code: 112, indent: 3, parameters: [] },
      { code: 111, indent: 4, parameters: [11, "ok"] },
      { code: 113, indent: 5, parameters: [] },
      ...
      { code: 413, indent: 1, parameters: [] },
      { code: 112, indent: 1, parameters: [] },
      { code: 122, indent: 2, parameters: [18, 18, 0, 0, 0] },
      { code: 111, indent: 2, parameters: [1, 22, 0, 2, 0] },
      { code: 122, indent: 3, parameters: [18, 18, 0, 0, -3] },
      { code: 113, indent: 3, parameters: [] },
      { code: 0, indent: 3, parameters: [] },
      { code: 412, indent: 2, parameters: [] },
      { code: 111, indent: 2, parameters: [1, 22, 0, 3, 0] },
      { code: 122, indent: 3, parameters: [18, 18, 0, 0, -5] },
      { code: 113, indent: 3, parameters: [] },
      { code: 0, indent: 3, parameters: [] },
      { code: 412, indent: 2, parameters: [] },
      { code: 111, indent: 2, parameters: [1, 22, 0, 4, 0] },
      { code: 122, indent: 3, parameters: [18, 18, 0, 0, 2] },
      { code: 113, indent: 3, parameters: [] },
      { code: 0, indent: 3, parameters: [] },
      { code: 412, indent: 2, parameters: [] },
      { code: 111, indent: 2, parameters: [1, 22, 0, 5, 0] },
      ...
      { code: 412, indent: 2, parameters: [] },
      { code: 111, indent: 2, parameters: [1, 22, 0, 1, 0] },
      { code: 111, indent: 3, parameters: [1, 16, 0, 0, 0] },
      { code: 122, indent: 4, parameters: [18, 18, 0, 0, -1] },
      { code: 113, indent: 4, parameters: [] },
      { code: 0, indent: 4, parameters: [] },
      { code: 412, indent: 3, parameters: [] },
      { code: 111, indent: 3, parameters: [1, 23, 1, 17, 3] },
      { code: 122, indent: 4, parameters: [18, 18, 0, 0, -1] },
      { code: 113, indent: 4, parameters: [] },
      { code: 0, indent: 4, parameters: [] },
      { code: 412, indent: 3, parameters: [] },
      { code: 111, indent: 3, parameters: [1, 23, 1, 17, 4] },
      { code: 122, indent: 4, parameters: [18, 18, 0, 0, 1] },
      { code: 113, indent: 4, parameters: [] },
      { code: 0, indent: 4, parameters: [] },
      { code: 412, indent: 3, parameters: [] },
      { code: 0, indent: 3, parameters: [] },
      { code: 412, indent: 2, parameters: [] },
      { code: 111, indent: 2, parameters: [1, 22, 0, 0, 0] },
      { code: 111, indent: 3, parameters: [1, 16, 0, 0, 3] },
      { code: 122, indent: 4, parameters: [18, 18, 0, 0, 1] },
      { code: 113, indent: 4, parameters: [] },
      { code: 0, indent: 4, parameters: [] },
      { code: 412, indent: 3, parameters: [] },
      ...
      { code: 0, indent: 2, parameters: [] },
      { code: 413, indent: 1, parameters: [] },
      { code: 118, indent: 1, parameters: ["親番の終了"] },
      { code: 122, indent: 1, parameters: [15, 15, 0, 1, 11] },
      { code: 122, indent: 1, parameters: [15, 15, 3, 1, 18] },
      { code: 111, indent: 1, parameters: [0, 2, 1] },
      { code: 122, indent: 2, parameters: [15, 15, 3, 0, -1] },
      { code: 0, indent: 2, parameters: [] },
      { code: 412, indent: 1, parameters: [] },
      { code: 125, indent: 1, parameters: [0, 1, 15] },
      { code: 122, indent: 1, parameters: [14, 14, 1, 1, 15] },
      { code: 111, indent: 1, parameters: [1, 15, 0, 0, 0] },
      { code: 101, indent: 2, parameters: ["", 0, 1, 1] },
      { code: 401, indent: 2, parameters: ["\\$引き分け。"] },
      { code: 0, indent: 2, parameters: [] },
      { code: 411, indent: 1, parameters: [] },
      { code: 111, indent: 2, parameters: [1, 15, 0, 0, 3] },
      {
        code: 250,
        indent: 3,
        parameters: [{ name: "Coin", volume: 90, pitch: 100, pan: 0 }],
      },
      { code: 101, indent: 3, parameters: ["", 0, 1, 1] },
      { code: 401, indent: 3, parameters: ["\\$\\V[15]\\Gの勝ち！"] },
      { code: 0, indent: 3, parameters: [] },
      { code: 411, indent: 2, parameters: [] },
      {
        code: 250,
        indent: 3,
        parameters: [{ name: "Shop1", volume: 90, pitch: 100, pan: 0 }],
      },
      { code: 101, indent: 3, parameters: ["", 0, 1, 1] },
      { code: 401, indent: 3, parameters: ["\\$\\V[15]\\Gの負け…"] },
      { code: 0, indent: 3, parameters: [] },
      { code: 412, indent: 2, parameters: [] },
      { code: 0, indent: 2, parameters: [] },
      { code: 412, indent: 1, parameters: [] },
      { code: 111, indent: 1, parameters: [1, 18, 0, 0, 2] },
      { code: 111, indent: 2, parameters: [0, 2, 0] },
      { code: 111, indent: 3, parameters: [0, 4, 0] },
      { code: 119, indent: 4, parameters: ["ゲーム終了"] },
      { code: 0, indent: 4, parameters: [] },
      { code: 411, indent: 3, parameters: [] },
      { code: 121, indent: 4, parameters: [3, 3, 0] },
      { code: 121, indent: 4, parameters: [2, 2, 1] },
      { code: 121, indent: 4, parameters: [6, 6, 1] },
      { code: 0, indent: 4, parameters: [] },
      { code: 412, indent: 3, parameters: [] },
      { code: 0, indent: 3, parameters: [] },
      { code: 411, indent: 2, parameters: [] },
      { code: 111, indent: 3, parameters: [0, 3, 0] },
      { code: 119, indent: 4, parameters: ["ゲーム終了"] },
      { code: 0, indent: 4, parameters: [] },
      { code: 411, indent: 3, parameters: [] },
      { code: 121, indent: 4, parameters: [4, 4, 0] },
      { code: 121, indent: 4, parameters: [2, 2, 0] },
      { code: 121, indent: 4, parameters: [6, 6, 1] },
      { code: 0, indent: 4, parameters: [] },
      { code: 412, indent: 3, parameters: [] },
      { code: 0, indent: 3, parameters: [] },
      ...
      { code: 0, indent: 2, parameters: [] },
      { code: 411, indent: 1, parameters: [] },
      { code: 121, indent: 2, parameters: [6, 6, 0] },
      { code: 0, indent: 2, parameters: [] },
      { code: 412, indent: 1, parameters: [] },
      { code: 0, indent: 1, parameters: [] },
      { code: 413, indent: 0, parameters: [] },
      { code: 118, indent: 0, parameters: ["ゲーム終了"] },
      { code: 111, indent: 0, parameters: [1, 14, 0, 0, 1] },
      {
        code: 250,
        indent: 1,
        parameters: [{ name: "Applause2", volume: 90, pitch: 100, pan: 0 }],
      },
      { code: 101, indent: 1, parameters: ["", 0, 1, 1] },
      { code: 401, indent: 1, parameters: ["\\$合計\\V[14]\\Gだけ勝った！"] },
      { code: 0, indent: 1, parameters: [] },
      { code: 411, indent: 0, parameters: [] },
      { code: 101, indent: 1, parameters: ["", 0, 1, 1] },
      {
        code: 401,
        indent: 1,
        parameters: ["\\$合計\\V[14]\\Gだけ負けてしまった……"],
      },
      { code: 0, indent: 1, parameters: [] },
      { code: 412, indent: 0, parameters: [] },
      { code: 356, indent: 0, parameters: ["ダイス クリア 1 10"] },
      { code: 356, indent: 0, parameters: ["ダイス クリア 2 10"] },
      { code: 356, indent: 0, parameters: ["ダイス クリア 3 10"] },
      { code: 356, indent: 0, parameters: ["ダイス クリア 4 10"] },
      { code: 356, indent: 0, parameters: ["ダイス クリア 5 10"] },
      { code: 356, indent: 0, parameters: ["ダイス クリア 6 10"] },
      { code: 223, indent: 0, parameters: [[0, 0, 0, 0], 30, true] },
      { code: 101, indent: 0, parameters: ["", 0, 0, 2] },
      { code: 401, indent: 0, parameters: ["【賭博師】"] },
      { code: 401, indent: 0, parameters: ["なかなかいい勝負だったぜ！"] },
  ...
  Game_Interpreter.prototype.trpDiceTest2 = function () {
    ...
    var list = [
      { code: 101, indent: 0, parameters: ["", 0, 0, 2] },
      {
        code: 401,
        indent: 0,
        parameters: ["\\>ダイスプラグインの動作テストを行います。"],
      },
      { code: 101, indent: 0, parameters: ["", 0, 0, 2] },
      { code: 401, indent: 0, parameters: ["\\>1.ダイスロール"] },
      { code: 356, indent: 0, parameters: ["dice type 1 チンチロ自分"] },
      { code: 356, indent: 0, parameters: ["dice show 1 408 150"] },
      { code: 356, indent: 0, parameters: ["dice 乱数ロール 1"] },
      { code: 356, indent: 0, parameters: ["dice wait"] },
      { code: 101, indent: 0, parameters: ["", 0, 0, 2] },
      { code: 401, indent: 0, parameters: ["\\>2.ダイスの移動・拡大"] },
      { code: 356, indent: 0, parameters: ["dice size 1 50 30"] },
      { code: 356, indent: 0, parameters: ["dice move 1 708 150 30"] },
      { code: 230, indent: 0, parameters: [30] },
      { code: 356, indent: 0, parameters: ["dice size 1 200 30"] },
      { code: 356, indent: 0, parameters: ["dice move 1 108 150 30"] },
      { code: 230, indent: 0, parameters: [30] },
      { code: 101, indent: 0, parameters: ["", 0, 0, 2] },
      { code: 401, indent: 0, parameters: ["\\>3.アニメーション・タイプ変更"] },
      { code: 356, indent: 0, parameters: ["dice animation 1 76"] },
      { code: 356, indent: 0, parameters: ["dice size 1 100"] },
      { code: 356, indent: 0, parameters: ["dice type 1 すごろく１０"] },
      { code: 230, indent: 0, parameters: [60] },
      { code: 101, indent: 0, parameters: ["", 0, 0, 2] },
      { code: 401, indent: 0, parameters: ["\\>4.非表示・表示・複数ダイス"] },
      { code: 356, indent: 0, parameters: ["dice hide 1 30"] },
      { code: 230, indent: 0, parameters: [30] },
      { code: 356, indent: 0, parameters: ["dice type 2 すごろく４"] },
      { code: 356, indent: 0, parameters: ["dice type 3 すごろく１"] },
      { code: 356, indent: 0, parameters: ["dice type 4 すごろく４５６"] },
      { code: 356, indent: 0, parameters: ["dice type 5 すごろく１０"] },
      { code: 356, indent: 0, parameters: ["dice type 6 すごろく１２３"] },
      { code: 356, indent: 0, parameters: ["dice show 1 108 150 30"] },
      { code: 356, indent: 0, parameters: ["dice change 1 4"] },
      { code: 230, indent: 0, parameters: [5] },
      { code: 356, indent: 0, parameters: ["dice show 2 228 150 30"] },
      { code: 356, indent: 0, parameters: ["dice change 2 4"] },
      { code: 230, indent: 0, parameters: [5] },
      { code: 356, indent: 0, parameters: ["dice show 3 348 150 30"] },
      { code: 356, indent: 0, parameters: ["dice change 3 4"] },
      { code: 230, indent: 0, parameters: [5] },
      { code: 356, indent: 0, parameters: ["dice show 4 468 150 30"] },
      { code: 356, indent: 0, parameters: ["dice change 4 4"] },
      { code: 230, indent: 0, parameters: [5] },
      { code: 356, indent: 0, parameters: ["dice show 5 588 150 30"] },
      { code: 356, indent: 0, parameters: ["dice change 5 4"] },
      { code: 230, indent: 0, parameters: [5] },
      { code: 356, indent: 0, parameters: ["dice show 6 708 150 30"] },
      { code: 356, indent: 0, parameters: ["dice change 6 4"] },
      { code: 230, indent: 0, parameters: [30] },
      { code: 356, indent: 0, parameters: ["dice randomroll 1 250 true"] },
      { code: 230, indent: 0, parameters: [5] },
      { code: 356, indent: 0, parameters: ["dice randomroll 2 250 true"] },
      { code: 230, indent: 0, parameters: [5] },
      { code: 356, indent: 0, parameters: ["dice randomroll 3 250 true"] },
      { code: 230, indent: 0, parameters: [5] },
      { code: 356, indent: 0, parameters: ["dice randomroll 4 250 true"] },
      { code: 230, indent: 0, parameters: [5] },
      { code: 356, indent: 0, parameters: ["dice randomroll 5 250 true"] },
      { code: 230, indent: 0, parameters: [5] },
      { code: 356, indent: 0, parameters: ["dice randomroll 6 250 true"] },
      { code: 356, indent: 0, parameters: ["dice wait"] },
      { code: 230, indent: 0, parameters: [5] },
      { code: 356, indent: 0, parameters: ["dice scale 1 120 5"] },
      { code: 230, indent: 0, parameters: [5] },
      { code: 356, indent: 0, parameters: ["dice scale 1 100 5"] },
      { code: 356, indent: 0, parameters: ["dice scale 2 120 5"] },
      { code: 230, indent: 0, parameters: [5] },
      { code: 356, indent: 0, parameters: ["dice roll 1 600 true"] },
      { code: 356, indent: 0, parameters: ["dice scale 2 100 5"] },
      { code: 356, indent: 0, parameters: ["dice scale 3 120 5"] },
      { code: 230, indent: 0, parameters: [5] },
      { code: 356, indent: 0, parameters: ["dice roll 2 600 true"] },
      { code: 356, indent: 0, parameters: ["dice scale 3 100 5"] },
      { code: 356, indent: 0, parameters: ["dice scale 4 120 5"] },
      { code: 230, indent: 0, parameters: [5] },
      { code: 356, indent: 0, parameters: ["dice roll 3 600 true"] },
      { code: 356, indent: 0, parameters: ["dice scale 4 100 5"] },
      { code: 356, indent: 0, parameters: ["dice scale 5 120 5"] },
      { code: 230, indent: 0, parameters: [5] },
      { code: 356, indent: 0, parameters: ["dice roll 4 600 true"] },
      { code: 356, indent: 0, parameters: ["dice scale 5 100 5"] },
      { code: 356, indent: 0, parameters: ["dice scale 6 120 5"] },
      { code: 230, indent: 0, parameters: [5] },
      { code: 356, indent: 0, parameters: ["dice roll 5 600 true"] },
      { code: 356, indent: 0, parameters: ["dice scale 6 100 5"] },
      { code: 230, indent: 0, parameters: [5] },
      { code: 356, indent: 0, parameters: ["dice roll 6 600 true"] },
      { code: 356, indent: 0, parameters: ["dice wait"] },
      { code: 356, indent: 0, parameters: ["dice clear 1"] },
      { code: 356, indent: 0, parameters: ["dice clear 2"] },
      { code: 356, indent: 0, parameters: ["dice clear 3"] },
      { code: 356, indent: 0, parameters: ["dice clear 4"] },
      { code: 356, indent: 0, parameters: ["dice clear 5"] },
      { code: 356, indent: 0, parameters: ["dice clear 6"] },
      { code: 101, indent: 0, parameters: ["", 0, 0, 2] },
      {
        code: 401,
        indent: 0,
        parameters: ["\\>以上でダイスプラグインの動作テストを終わります。"],
      },
      { code: 0, indent: 0, parameters: [] },
    ];
    this.setupChild(list, eventId);
  ...
  Game_Interpreter.prototype.trpDiceTest3 = function () {
    ...
    var list = [
      { code: 101, indent: 0, parameters: ["", 0, 0, 2] },
      {
        code: 401,
        indent: 0,
        parameters: ["\\>\\C[24]「カスタム情報ウィンドウプラグイン」\\C[0]の"],
      },
      { code: 401, indent: 0, parameters: ["\\>動作テストを行います。"] },
      { code: 356, indent: 0, parameters: ["ウィンドウ クリア 全て"] },
      { code: 230, indent: 0, parameters: [10] },
      { code: 122, indent: 0, parameters: [117, 117, 0, 0, 30] },
      { code: 122, indent: 0, parameters: [118, 118, 0, 0, 15] },
      { code: 122, indent: 0, parameters: [119, 119, 0, 0, 10] },
      { code: 122, indent: 0, parameters: [120, 120, 0, 0, 5] },
      { code: 122, indent: 0, parameters: [121, 121, 0, 0, 0] },
      { code: 122, indent: 0, parameters: [122, 122, 0, 0, -10] },
      {
        code: 356,
        indent: 0,
        parameters: ["ウィンドウ パーツ作成 評価左 テキスト 180 24"],
      },
      {
        code: 356,
        indent: 0,
        parameters: ["ウィンドウ パーツ設定 評価左 fontSize:18"],
      },
      {
        code: 356,
        indent: 0,
        parameters: ["ウィンドウ パーツ作成 評価右 テキスト 180 24"],
      },
      {
        code: 356,
        indent: 0,
        parameters: ["ウィンドウ パーツ設定 評価右 fontSize:18 align:right"],
      },
      { code: 356, indent: 0, parameters: ["ウィンドウ 作成 1D6詳細 180 125"] },
      {
        code: 356,
        indent: 0,
        parameters: [
          "ウィンドウ パーツ登録 1D6詳細 評価左 0 0 判定：\\C[24]\\V[107]\\C[0]",
        ],
      },
      {
        code: 356,
        indent: 0,
        parameters: [
          "ウィンドウ パーツ登録 1D6詳細 評価左 0 25 要求値：\\S[62]\\C[14]？？？\\C[0]:\\V[103]",
        ],
      },
      {
        code: 356,
        indent: 0,
        parameters: [
          "ウィンドウ パーツ登録 1D6詳細 評価左 0 50 パーティー評価値：\\V[108]",
        ],
      },
      {
        code: 356,
        indent: 0,
        parameters: [
          "ウィンドウ パーツ登録 1D6詳細 評価右 0 75 └（最高値：\\V[109]）",
        ],
      },
      {
        code: 356,
        indent: 0,
        parameters: [
          "ウィンドウ パーツ登録 1D6詳細 評価右 0 100 └（平均値：\\V[110]）",
        ],
      },
      { code: 356, indent: 0, parameters: ["ウィンドウ 作成 1D6結果 180 248"] },
      {
        code: 356,
        indent: 0,
        parameters: [
          "ウィンドウ パーツ作成 ハイライト 画像 0 0 dice_list_highlight",
        ],
      },
      {
        code: 356,
        indent: 0,
        parameters: [
          "ウィンドウ パーツ設定 ハイライト sprite:true underContents:true",
        ],
      },
      {
        code: 356,
        indent: 0,
        parameters: ["ウィンドウ パーツ登録 1D6結果 ハイライト 5 10"],
      },
      {
        code: 356,
        indent: 0,
        parameters: [
          "ウィンドウ スプライト 1D6結果 ハイライト opacity:170 visible:false",
        ],
      },
      {
        code: 356,
        indent: 0,
        parameters: ["ウィンドウ パーツ作成 サイコロ 画像 0 0 dice_list"],
      },
      {
        code: 356,
        indent: 0,
        parameters: ["ウィンドウ パーツ設定 サイコロ sprite:true"],
      },
      {
        code: 356,
        indent: 0,
        parameters: ["ウィンドウ パーツ登録 1D6結果 サイコロ 0 0"],
      },
      {
        code: 356,
        indent: 0,
        parameters: ["ウィンドウ パーツ作成 行テキスト テキスト 140 38"],
      },
      {
        code: 356,
        indent: 0,
        parameters: ["ウィンドウ パーツ設定 行テキスト fontSize:22"],
      },
      {
        code: 356,
        indent: 0,
        parameters: [
          "ウィンドウ パーツ登録 1D6結果 行テキスト 45 8 \\S[64]\\C[6]:\\C[8]\\S\\V[123]→評価\\V[111]",
        ],
      },
      {
        code: 356,
        indent: 0,
        parameters: [
          "ウィンドウ パーツ登録 1D6結果 行テキスト 45 47 \\S[65]\\C[6]:\\C[8]\\S\\V[124]→評価\\V[112]",
        ],
      },
      {
        code: 356,
        indent: 0,
        parameters: [
          "ウィンドウ パーツ登録 1D6結果 行テキスト 45 86 \\S[66]\\C[6]:\\C[8]\\S\\V[125]→評価\\V[113]",
        ],
      },
      {
        code: 356,
        indent: 0,
        parameters: [
          "ウィンドウ パーツ登録 1D6結果 行テキスト 45 125 \\S[67]\\C[6]:\\C[8]\\S\\V[126]→評価\\V[114]",
        ],
      },
      {
        code: 356,
        indent: 0,
        parameters: [
          "ウィンドウ パーツ登録 1D6結果 行テキスト 45 164 \\S[68]\\C[6]:\\C[8]\\S\\V[127]→評価\\V[115]",
        ],
      },
      {
        code: 356,
        indent: 0,
        parameters: [
          "ウィンドウ パーツ登録 1D6結果 行テキスト 45 203 \\S[69]\\C[6]:\\C[8]\\S\\V[128]→評価\\V[116]",
        ],
      },
      {
        code: 122,
        ...
        parameters: [
          ...
          0,
          4,
          "var value=$gameVariables.value(117); (value>=0 ? '+'+value : value)",
        ],
      },
      {
        code: 122,
        ...
        parameters: [
          ...
          0,
          4,
          "var value=$gameVariables.value(118); (value>=0 ? '+'+value : value)",
        ],
      },
      {
        code: 122,
        ...
        parameters: [
          ...
          0,
          4,
          "var value=$gameVariables.value(119); (value>=0 ? '+'+value : value)",
        ],
      },
      {
        code: 122,
        ...
        parameters: [
          ...
          0,
          4,
          "var value=$gameVariables.value(120); (value>=0 ? '+'+value : value)",
        ],
      },
      {
        code: 122,
        ...
        parameters: [
          ...
          0,
          4,
          "var value=$gameVariables.value(121); (value>=0 ? '+'+value : value)",
        ],
      },
      {
        code: 122,
        ...
        parameters: [
          ...
          0,
          4,
          "var value=$gameVariables.value(122); (value>=0 ? '+'+value : value)",
        ],
      },
      {
        code: 356,
        indent: 0,
        parameters: ["ウィンドウ 作成 1D100詳細 200 125"],
      },
      {
        code: 356,
        indent: 0,
        parameters: [
          "ウィンドウ パーツ登録 1D100詳細 評価左 0 0 判定：\\C[24]\\V[107]\\C[0]",
        ],
      },
      {
        code: 356,
        indent: 0,
        parameters: [
          "ウィンドウ パーツ登録 1D100詳細 評価左 0 25 対抗値：\\S[62]\\C[14]？？？\\C[0]:\\V[103]",
        ],
      },
      {
        code: 356,
        indent: 0,
        parameters: [
          "ウィンドウ パーツ登録 1D100詳細 評価左 0 50 パーティー評価値：\\V[108]",
        ],
      },
      {
        code: 356,
        indent: 0,
        parameters: [
          "ウィンドウ パーツ登録 1D100詳細 評価右 0 75 └（最高値：\\V[109]）",
        ],
      },
      {
        code: 356,
        indent: 0,
        parameters: [
          "ウィンドウ パーツ登録 1D100詳細 評価右 0 100 └（平均値：\\V[110]）",
        ],
      },
      {
        code: 356,
        indent: 0,
        parameters: ["ウィンドウ 作成 1D100結果 200 170"],
      },
      {
        code: 356,
        indent: 0,
        parameters: [
          "ウィンドウ パーツ作成 ハイライト2 画像 0 0 dice_list_highlight_long",
        ],
      },
      {
        code: 356,
        indent: 0,
        parameters: [
          "ウィンドウ パーツ設定 ハイライト2 sprite:true underContents:true",
        ],
      },
      {
        code: 356,
        indent: 0,
        parameters: ["ウィンドウ パーツ登録 1D100結果 ハイライト2 0 10"],
      },
      {
        code: 356,
        indent: 0,
        parameters: ["ウィンドウ パーツ作成 行テキスト2 テキスト 190 38"],
      },
      {
        code: 356,
        indent: 0,
        parameters: ["ウィンドウ パーツ設定 行テキスト2 fontSize:21"],
      },
      {
        code: 356,
        indent: 0,
        parameters: [
          "ウィンドウ パーツ登録 1D100結果 行テキスト2 5 8 96~00:\\C[2]ファンブル",
        ],
      },
      {
        code: 356,
        indent: 0,
        parameters: [
          "ウィンドウ パーツ登録 1D100結果 行テキスト2 5 47 \\V[131]-95:\\C[8]失敗",
        ],
      },
      {
        code: 356,
        indent: 0,
        parameters: [
          "ウィンドウ パーツ登録 1D100結果 行テキスト2 5 86 06~\\V[130]:\\C[0]成功",
        ],
      },
      {
        code: 356,
        indent: 0,
        parameters: [
          "ウィンドウ パーツ登録 1D100結果 行テキスト2 5 125 01~05:\\C[6]クリティカル",
        ],
      },
      { code: 122, indent: 0, parameters: [102, 102, 0, 0, 6] },
      { code: 122, indent: 0, parameters: [103, 103, 0, 0, 35] },
      { code: 111, indent: 0, parameters: [1, 102, 0, 0, 1] },
      { code: 355, indent: 1, parameters: ["var variableId = 102;"] },
      {
        code: 655,
        indent: 1,
        parameters: ["var paramId = $gameVariables.value(variableId);"],
      },
      {
        code: 655,
        indent: 1,
        parameters: ["var maxValue = 0, totalValue = 0;"],
      },
      {
        code: 655,
        indent: 1,
        parameters: ["$gameParty.members().forEach(function(member){"],
      },
      {
        code: 655,
        indent: 1,
        parameters: [" var value = member.param(paramId);"],
      },
      { code: 655, indent: 1, parameters: [" totalValue += value;"] },
      {
        code: 655,
        indent: 1,
        parameters: [" if(value > maxValue) maxValue = value;"],
      },
      { code: 655, indent: 1, parameters: ["});"] },
      {
        code: 655,
        indent: 1,
        parameters: ["$gameVariables.setValue(109,maxValue);"],
      },
      {
        code: 655,
        indent: 1,
        parameters: ["var average = totalValue/$gameParty.members().length"],
      },
      {
        code: 655,
        indent: 1,
        parameters: ["$gameVariables.setValue(110,average);"],
      },
      { code: 122, indent: 1, parameters: [108, 108, 0, 1, 109] },
      { code: 122, indent: 1, parameters: [108, 108, 1, 1, 110] },
      { code: 122, indent: 1, parameters: [108, 108, 4, 0, 2] },
      { code: 0, indent: 1, parameters: [] },
      { code: 411, indent: 0, parameters: [] },
      { code: 122, indent: 1, parameters: [108, 108, 0, 0, 0] },
      { code: 0, indent: 1, parameters: [] },
      { code: 412, indent: 0, parameters: [] },
      { code: 111, indent: 0, parameters: [1, 102, 0, 0, 1] },
      {
        ...
        parameters: [
          ...
          0,
          4,
          "var variableId=102; var paramId=$gameVariables.value(variableId); TextManager.param(paramId);",
        ],
      },
      { code: 0, indent: 1, parameters: [] },
      { code: 411, indent: 0, parameters: [] },
      { code: 122, indent: 1, parameters: [107, 107, 0, 4, "'固定確率'"] },
      { code: 0, indent: 1, parameters: [] },
      { code: 412, indent: 0, parameters: [] },
      { code: 122, indent: 0, parameters: [111, 111, 0, 1, 108] },
      { code: 122, indent: 0, parameters: [111, 111, 1, 1, 117] },
      { code: 122, indent: 0, parameters: [112, 112, 0, 1, 108] },
      { code: 122, indent: 0, parameters: [112, 112, 1, 1, 118] },
      { code: 122, indent: 0, parameters: [113, 113, 0, 1, 108] },
      { code: 122, indent: 0, parameters: [113, 113, 1, 1, 119] },
      { code: 122, indent: 0, parameters: [114, 114, 0, 1, 108] },
      { code: 122, indent: 0, parameters: [114, 114, 1, 1, 120] },
      { code: 122, indent: 0, parameters: [115, 115, 0, 1, 108] },
      { code: 122, indent: 0, parameters: [115, 115, 1, 1, 121] },
      { code: 122, indent: 0, parameters: [116, 116, 0, 1, 108] },
      { code: 122, indent: 0, parameters: [116, 116, 1, 1, 122] },
      { code: 111, indent: 0, parameters: [0, 62, 0] },
      { code: 121, indent: 1, parameters: [64, 64, 1] },
      { code: 121, indent: 1, parameters: [65, 65, 1] },
      { code: 121, indent: 1, parameters: [66, 66, 1] },
      { code: 121, indent: 1, parameters: [67, 67, 1] },
      { code: 121, indent: 1, parameters: [68, 68, 1] },
      { code: 121, indent: 1, parameters: [69, 69, 1] },
      { code: 115, indent: 1, parameters: [] },
      { code: 0, indent: 1, parameters: [] },
      { code: 412, indent: 0, parameters: [] },
      { code: 111, indent: 0, parameters: [1, 111, 1, 103, 1] },
      { code: 121, indent: 1, parameters: [64, 64, 0] },
      { code: 0, indent: 1, parameters: [] },
      { code: 411, indent: 0, parameters: [] },
      { code: 121, indent: 1, parameters: [64, 64, 1] },
      { code: 0, indent: 1, parameters: [] },
      { code: 412, indent: 0, parameters: [] },
      { code: 111, indent: 0, parameters: [1, 112, 1, 103, 1] },
      { code: 121, indent: 1, parameters: [65, 65, 0] },
      { code: 0, indent: 1, parameters: [] },
      { code: 411, indent: 0, parameters: [] },
      { code: 121, indent: 1, parameters: [65, 65, 1] },
      { code: 0, indent: 1, parameters: [] },
      { code: 412, indent: 0, parameters: [] },
      { code: 111, indent: 0, parameters: [1, 113, 1, 103, 1] },
      { code: 121, indent: 1, parameters: [66, 66, 0] },
      { code: 0, indent: 1, parameters: [] },
      { code: 411, indent: 0, parameters: [] },
      { code: 121, indent: 1, parameters: [66, 66, 1] },
      { code: 0, indent: 1, parameters: [] },
      { code: 412, indent: 0, parameters: [] },
      { code: 111, indent: 0, parameters: [1, 114, 1, 103, 1] },
      { code: 121, indent: 1, parameters: [67, 67, 0] },
      { code: 0, indent: 1, parameters: [] },
      { code: 411, indent: 0, parameters: [] },
      { code: 121, indent: 1, parameters: [67, 67, 1] },
      { code: 0, indent: 1, parameters: [] },
      { code: 412, indent: 0, parameters: [] },
      { code: 111, indent: 0, parameters: [1, 115, 1, 103, 1] },
      { code: 121, indent: 1, parameters: [68, 68, 0] },
      { code: 0, indent: 1, parameters: [] },
      { code: 411, indent: 0, parameters: [] },
      { code: 121, indent: 1, parameters: [68, 68, 1] },
      { code: 0, indent: 1, parameters: [] },
      { code: 412, indent: 0, parameters: [] },
      { code: 111, indent: 0, parameters: [1, 116, 1, 103, 1] },
      { code: 121, indent: 1, parameters: [69, 69, 0] },
      { code: 0, indent: 1, parameters: [] },
      { code: 411, indent: 0, parameters: [] },
      { code: 121, indent: 1, parameters: [69, 69, 1] },
      { code: 0, indent: 1, parameters: [] },
      { code: 412, indent: 0, parameters: [] },
      { code: 356, indent: 0, parameters: ["ウィンドウ 表示 1D6詳細 550 100"] },
      { code: 101, indent: 0, parameters: ["", 0, 0, 2] },
      {
        code: 401,
        indent: 0,
        parameters: ["\\>画像・テキストを自由に配置したウィンドウを表示する"],
      },
      {
        code: 401,
        indent: 0,
        parameters: [
          "\\>\\C[14]「マップ上での情報表示に特化」\\C[0]した付属プラグインです。",
        ],
      },
      { code: 101, indent: 0, parameters: ["", 0, 0, 2] },
      {
        code: 401,
        indent: 0,
        parameters: ["\\>制御文字で指定した変数が変わると、"],
      },
      { code: 401, indent: 0, parameters: ["\\>自動で表示内容も変わります。"] },
      {
        code: 401,
        indent: 0,
        parameters: ["\\>（右上ウィンドウの「要求値」に注目）"],
      },
      { code: 230, indent: 0, parameters: [5] },
      { code: 122, indent: 0, parameters: [103, 103, 2, 0, 1] },
      { code: 230, indent: 0, parameters: [5] },
      { code: 122, indent: 0, parameters: [103, 103, 2, 0, 1] },
      { code: 230, indent: 0, parameters: [5] },
      { code: 122, indent: 0, parameters: [103, 103, 2, 0, 1] },
      ...
      { code: 230, indent: 0, parameters: [5] },
      { code: 122, indent: 0, parameters: [103, 103, 2, 0, 1] },
      { code: 230, indent: 0, parameters: [20] },
      { code: 122, indent: 0, parameters: [103, 103, 1, 0, 1] },
      { code: 230, indent: 0, parameters: [5] },
      { code: 122, indent: 0, parameters: [103, 103, 1, 0, 1] },
      { code: 230, indent: 0, parameters: [5] },
      { code: 122, indent: 0, parameters: [103, 103, 1, 0, 1] },
      ...
      { code: 230, indent: 0, parameters: [20] },
      {
        code: 356,
        indent: 0,
        parameters: ["ウィンドウ スプライト 1D6結果 ハイライト visible:false"],
      },
      { code: 356, indent: 0, parameters: ["ウィンドウ 表示 1D6結果 550 255"] },
      { code: 223, indent: 0, parameters: [[-100, -100, -100, 0], 20, true] },
      { code: 356, indent: 0, parameters: ["ダイス クリア 1"] },
      { code: 356, indent: 0, parameters: ["ダイス タイプ 1 TRPG風6"] },
      { code: 356, indent: 0, parameters: ["ダイス 変数 1 104"] },
      { code: 356, indent: 0, parameters: ["ダイス 拡大 1 150"] },
      { code: 356, indent: 0, parameters: ["ダイス 表示 1 300 350"] },
      { code: 356, indent: 0, parameters: ["ダイス 乱数ロール 1"] },
      { code: 111, indent: 0, parameters: [1, 104, 0, 6, 0] },
      { code: 122, indent: 1, parameters: [106, 106, 0, 1, 111] },
      {
        code: 356,
        indent: 1,
        parameters: ["ウィンドウ スプライト 1D6結果 ハイライト y:eval_10+39*0"],
      },
      { code: 0, indent: 1, parameters: [] },
      { code: 412, indent: 0, parameters: [] },
      { code: 111, indent: 0, parameters: [1, 104, 0, 5, 0] },
      { code: 122, indent: 1, parameters: [106, 106, 0, 1, 112] },
      {
        code: 356,
        indent: 1,
        parameters: ["ウィンドウ スプライト 1D6結果 ハイライト y:eval_10+39*1"],
      },
      { code: 0, indent: 1, parameters: [] },
      { code: 412, indent: 0, parameters: [] },
      { code: 111, indent: 0, parameters: [1, 104, 0, 4, 0] },
      { code: 122, indent: 1, parameters: [106, 106, 0, 1, 113] },
      {
        code: 356,
        indent: 1,
        parameters: ["ウィンドウ スプライト 1D6結果 ハイライト y:eval_10+39*2"],
      },
      { code: 0, indent: 1, parameters: [] },
      { code: 412, indent: 0, parameters: [] },
      { code: 111, indent: 0, parameters: [1, 104, 0, 3, 0] },
      { code: 122, indent: 1, parameters: [106, 106, 0, 1, 114] },
      {
        code: 356,
        indent: 1,
        parameters: ["ウィンドウ スプライト 1D6結果 ハイライト y:eval_10+39*3"],
      },
      { code: 0, indent: 1, parameters: [] },
      { code: 412, indent: 0, parameters: [] },
      { code: 111, indent: 0, parameters: [1, 104, 0, 2, 0] },
      { code: 122, indent: 1, parameters: [106, 106, 0, 1, 115] },
      {
        code: 356,
        indent: 1,
        parameters: ["ウィンドウ スプライト 1D6結果 ハイライト y:eval_10+39*4"],
      },
      { code: 0, indent: 1, parameters: [] },
      { code: 412, indent: 0, parameters: [] },
      { code: 111, indent: 0, parameters: [1, 104, 0, 1, 0] },
      { code: 122, indent: 1, parameters: [106, 106, 0, 1, 116] },
      {
        code: 356,
        indent: 1,
        parameters: ["ウィンドウ スプライト 1D6結果 ハイライト y:eval_10+39*5"],
      },
      { code: 0, indent: 1, parameters: [] },
      { code: 412, indent: 0, parameters: [] },
      { code: 111, indent: 0, parameters: [1, 106, 1, 103, 1] },
      { code: 121, indent: 1, parameters: [63, 63, 0] },
      { code: 0, indent: 1, parameters: [] },
      { code: 411, indent: 0, parameters: [] },
      { code: 121, indent: 1, parameters: [63, 63, 1] },
      { code: 0, indent: 1, parameters: [] },
      { code: 412, indent: 0, parameters: [] },
      { code: 230, indent: 0, parameters: [30] },
      {
        code: 356,
        indent: 0,
        parameters: ["ウィンドウ スプライト 1D6結果 ハイライト visible:true"],
      },
      { code: 230, indent: 0, parameters: [2] },
      {
        code: 356,
        indent: 0,
        parameters: ["ウィンドウ スプライト 1D6結果 ハイライト visible:false"],
      ...
      { code: 230, indent: 0, parameters: [4] },
      {
        code: 356,
        indent: 0,
        parameters: ["ウィンドウ スプライト 1D6結果 ハイライト visible:true"],
      ...
      },
      {
        code: 250,
        indent: 0,
        parameters: [{ name: "Cursor2", volume: 90, pitch: 100, pan: 0 }],
      },
      { code: 101, indent: 0, parameters: ["", 0, 0, 2] },
      {
        code: 401,
        indent: 0,
        parameters: ["\\>ハイライト部分は画像で表示しており、"],
      },
      {
        code: 401,
        indent: 0,
        parameters: ["\\>位置を随時変更することが可能です。"],
      },
      { code: 356, indent: 0, parameters: ["ウィンドウ 非表示 1D6詳細"] },
      { code: 356, indent: 0, parameters: ["ウィンドウ 非表示 1D6結果"] },
      { code: 356, indent: 0, parameters: ["ダイス 非表示 1"] },
      { code: 223, indent: 0, parameters: [[0, 0, 0, 0], 20, true] },
      {
        code: 108,
        indent: 0,
        parameters: [
      ...
      { code: 122, indent: 0, parameters: [102, 102, 0, 0, -1] },
      { code: 122, indent: 0, parameters: [103, 103, 0, 0, -3] },
      { code: 111, indent: 0, parameters: [1, 102, 0, 0, 1] },
      { code: 355, indent: 1, parameters: ["var variableId = 102;"] },
      {
        code: 655,
      ...
      { code: 0, indent: 1, parameters: [] },
      { code: 412, indent: 0, parameters: [] },
      { code: 122, indent: 0, parameters: [130, 130, 0, 1, 108] },
      { code: 122, indent: 0, parameters: [130, 130, 2, 1, 103] },
      { code: 122, indent: 0, parameters: [130, 130, 3, 0, 5] },
      { code: 122, indent: 0, parameters: [130, 130, 1, 0, 50] },
      { code: 111, indent: 0, parameters: [1, 130, 0, 5, 2] },
      { code: 122, indent: 1, parameters: [130, 130, 0, 0, 6] },
      { code: 0, indent: 1, parameters: [] },
      { code: 412, indent: 0, parameters: [] },
      { code: 111, indent: 0, parameters: [1, 130, 0, 95, 1] },
      { code: 122, indent: 1, parameters: [130, 130, 0, 0, 94] },
      { code: 0, indent: 1, parameters: [] },
      { code: 412, indent: 0, parameters: [] },
      { code: 122, indent: 0, parameters: [131, 131, 0, 1, 130] },
      { code: 122, indent: 0, parameters: [131, 131, 1, 0, 1] },
      {
        code: 356,
        indent: 0,
        parameters: ["ウィンドウ 表示 1D100詳細 550 100"],
      },
      { code: 111, indent: 0, parameters: [0, 62, 1] },
      {
        code: 356,
        indent: 1,
        parameters: ["ウィンドウ 表示 1D100結果 550 255"],
      },
      {
        code: 356,
        indent: 1,
        parameters: [
          "ウィンドウ スプライト 1D100結果 ハイライト2 visible:false",
        ],
      },
      { code: 0, indent: 1, parameters: [] },
      { code: 412, indent: 0, parameters: [] },
      { code: 223, indent: 0, parameters: [[-100, -100, -100, 0], 20, true] },
      { code: 356, indent: 0, parameters: ["ダイス クリア 1"] },
      { code: 356, indent: 0, parameters: ["ダイス クリア 2"] },
      { code: 356, indent: 0, parameters: ["ダイス タイプ 1 TRPG風10-1"] },
      { code: 356, indent: 0, parameters: ["ダイス タイプ 2 TRPG風10-2"] },
      { code: 356, indent: 0, parameters: ["ダイス 拡大 1 125"] },
      { code: 356, indent: 0, parameters: ["ダイス 拡大 2 125"] },
      { code: 356, indent: 0, parameters: ["ダイス 変数 1 104"] },
      { code: 356, indent: 0, parameters: ["ダイス 変数 2 105"] },
      { code: 356, indent: 0, parameters: ["ダイス 表示 1 220 350"] },
      { code: 356, indent: 0, parameters: ["ダイス 表示 2 380 350"] },
      { code: 356, indent: 0, parameters: ["ダイス 乱数ロール 1"] },
      { code: 356, indent: 0, parameters: ["ダイス 乱数ロール 2"] },
      { code: 122, indent: 0, parameters: [129, 129, 0, 1, 104] },
      { code: 122, indent: 0, parameters: [129, 129, 3, 0, 10] },
      { code: 122, indent: 0, parameters: [129, 129, 1, 1, 105] },
      { code: 111, indent: 0, parameters: [1, 129, 0, 0, 0] },
      { code: 122, indent: 1, parameters: [129, 129, 0, 0, 100] },
      { code: 0, indent: 1, parameters: [] },
      { code: 412, indent: 0, parameters: [] },
      { code: 111, indent: 0, parameters: [1, 129, 0, 96, 1] },
      { code: 111, indent: 1, parameters: [0, 62, 1] },
      {
        code: 356,
        indent: 2,
        parameters: [
          "ウィンドウ スプライト 1D100結果 ハイライト2 y:eval_10+39*0",
        ],
      },
      { code: 0, indent: 2, parameters: [] },
      { code: 412, indent: 1, parameters: [] },
      { code: 122, indent: 1, parameters: [133, 133, 0, 0, 4] },
      { code: 0, indent: 1, parameters: [] },
      { code: 411, indent: 0, parameters: [] },
      { code: 111, indent: 1, parameters: [1, 129, 1, 131, 1] },
      { code: 111, indent: 2, parameters: [0, 62, 1] },
      {
        code: 356,
        indent: 3,
        parameters: [
          "ウィンドウ スプライト 1D100結果 ハイライト2 y:eval_10+39*1",
        ],
      },
      { code: 0, indent: 3, parameters: [] },
      { code: 412, indent: 2, parameters: [] },
      { code: 122, indent: 2, parameters: [133, 133, 0, 0, 3] },
      { code: 0, indent: 2, parameters: [] },
      { code: 411, indent: 1, parameters: [] },
      { code: 111, indent: 2, parameters: [1, 129, 0, 6, 1] },
      { code: 111, indent: 3, parameters: [0, 62, 1] },
      {
        code: 356,
        indent: 4,
        parameters: [
          "ウィンドウ スプライト 1D100結果 ハイライト2 y:eval_10+39*2",
        ],
      },
      { code: 0, indent: 4, parameters: [] },
      { code: 412, indent: 3, parameters: [] },
      { code: 122, indent: 3, parameters: [133, 133, 0, 0, 2] },
      { code: 0, indent: 3, parameters: [] },
      { code: 411, indent: 2, parameters: [] },
      { code: 111, indent: 3, parameters: [0, 62, 1] },
      {
        ...
        indent: 4,
        parameters: [
          "ウィンドウ スプライト 1D100結果 ハイライト2 y:eval_10+39*3",
        ],
      },
      { code: 0, indent: 4, parameters: [] },
      { code: 412, indent: 3, parameters: [] },
      { code: 122, indent: 3, parameters: [133, 133, 0, 0, 1] },
      { code: 0, indent: 3, parameters: [] },
      { code: 412, indent: 2, parameters: [] },
      { code: 0, indent: 2, parameters: [] },
      { code: 412, indent: 1, parameters: [] },
      ...
      { code: 412, indent: 0, parameters: [] },
      { code: 111, indent: 0, parameters: [0, 62, 1] },
      { code: 230, indent: 1, parameters: [15] },
      {
        code: 356,
        indent: 1,
        parameters: [
      ...
      { code: 230, indent: 1, parameters: [30] },
      {
        ...
        indent: 1,
        parameters: [
          "ウィンドウ スプライト 1D100結果 ハイライト2 visible:true",
        ],
      },
      ...
      { code: 230, indent: 1, parameters: [4] },
      {
        code: 356,
        indent: 1,
        parameters: [
      ...
      { code: 101, indent: 0, parameters: ["", 0, 0, 2] },
      {
        ...
        indent: 0,
        parameters: [
          "\\>「TRPG風判定システム」の他にも\\C[14]「すごろくミニゲーム」",
        ],
      },
      {
        code: 401,
        indent: 0,
        parameters: [
          "\\>「サイコロを使ったダンジョンギミック」、「戦闘スキル」\\C[0]",
        ],
      },
      {
        code: 401,
        indent: 0,
        parameters: ["\\>などのサンプルをシステムを自作する際の参考として"],
      },
      {
        code: 401,
        indent: 0,
        parameters: [
          "\\>\\C[24]コモンイベントに解説コメント付きで用意\\C[0]しております。",
        ],
      },
      { code: 101, indent: 0, parameters: ["", 0, 0, 2] },
      {
        code: 401,
        indent: 0,
        parameters: ["\\>また、データベースでコモンイベントや変数をコピーして"],
      },
      {
        code: 401,
        indent: 0,
        parameters: [
          "\\>ご自身のプロジェクトでそのまま使って頂くこともできます。",
        ],
      },
      { code: 356, indent: 0, parameters: ["ウィンドウ 非表示 1D100詳細"] },
      { code: 111, indent: 0, parameters: [0, 62, 1] },
      { code: 356, indent: 1, parameters: ["ウィンドウ 非表示 1D100結果"] },
      { code: 0, indent: 1, parameters: [] },
      { code: 412, indent: 0, parameters: [] },
      { code: 356, indent: 0, parameters: ["ダイス 非表示 1"] },
      { code: 356, indent: 0, parameters: ["ダイス 非表示 2"] },
      { code: 223, indent: 0, parameters: [[0, 0, 0, 0], 20, true] },
      { code: 101, indent: 0, parameters: ["", 0, 0, 2] },
      {
        code: 401,
        indent: 0,
        parameters: ["\\>これで、付属のカスタム情報ウィンドウプラグインの"],
      },
      { code: 401, indent: 0, parameters: ["\\>動作テストを終了します。"] },
      { code: 0, indent: 0, parameters: [] },
    ];
    this.setupChild(list, eventId);
  };

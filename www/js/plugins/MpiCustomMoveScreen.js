...
(function () {
    ...
    _plugin.unaffected_picture = (eval(_parameters['Unaffected Picture']) || []).map(v => Number(v));
    ...
    //==============================================================================
    {
        ...
        Game_Picture.prototype.x = function () {
            if (!this.hasOwnProperty('_cms_unaffected')) {
                this._cms_unaffected = _plugin.unaffected_picture.includes($gameScreen._pictures.indexOf(this) - $gameScreen.realPictureId(0));
            }
            return __x.apply(this, arguments) - ((this._cms_unaffected) ? $gameScreen._custom_move_x : 0);
        };
        ...
        Game_Picture.prototype.y = function () {
            ...
            return __y.apply(this, arguments) - ((this._cms_unaffected) ? $gameScreen._custom_move_y : 0);
        };
    }

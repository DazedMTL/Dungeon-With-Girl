...
var $plugins = [
  ...
  },
  {
    ...
    status: true,
    description:
      "ver1.031/さまざまな情報を表示するミニウィンドウを定義します。",
    parameters: {
      "【基本設定】": "",
      "Switch Key": "tab,menu",
      "Default State": "open",
      ...
      "Window Offset Y": "0",
      "Use Scene Item": "true",
      "Use Scene Skill": "true",
      "Use Scene Equip": "true",
      "Use Scene Shop": "true",
      "【用語の設定】": "",
      "Effect Name": "有効度",
      "Down Name": "低下有効度",
      "Turn Text": "Turn",
      "Escape Text": "Escape",
      "Param Color": "6,4,24,2",
      "Param Text1": ",,無効化",
      "Param Text2":
        "Hit Rate, Evasion, Critical, Critical Evasion, Magic Evasion, Magic Reflection, Counter, Regeneration, Regeneration, Regeneration",
      "Param Text3":
        "Target Rate, Healing Rate, Recovery Rate, Consumption Rate, Physical DMG Rate, Magic DMG Rate, Floor DMG Rate, Experience Rate",
      "Param Text4": "Attribute: ,Status: ,ATK Speed,ATK #",
      "Param Text5":
        "Add Skill Type:, Seal Skill Type:, Add Skill:, Seal Skill:",
      "Param Text6":
        "Add Weapon Type:, Add Armor Type:, Equipment Locked:, Equipment Sealed:, Dual Wielding",
      "Param Text7":
        "Additional Action Count, Auto Battle, Defend, Substitute, TP Carryover, Disappearance Effect, Encounter Rate Reduction, Encounter Nullification, Ambush Nullification, Preemptive Rate Increase, Gold Multiplier, Item Multiplier",
      "Defeat Text": "Normal, Boss, Instant Loss, Indestructible",
      "Effects Names":
        "HP Recovery, HP Damage, MP Recovery, MP Damage, TP Increase, State Infliction, State Removal, Buff Infliction, Debuff Infliction, Buff Removal, Debuff Removal, Special Effect, Growth, Skill Acquisition, Common",
    },
  },
  {
    name: "NoGameover2",
    ...
    parameters: { "Switch ID": "121", "Switch ID2": "0" },
  },
  {
    name: "DrainExtend",
    status: true,
    description: "吸収拡張プラグイン",
    parameters: { 回復効果音: "true" },
  },
  {
    name: "YEP_ItemCore",
    status: true,
    description:
      "v1.30 Changes the way Items are handled for your game\nand the Item Scene, too.",
    parameters: {
      "---General---": "",
      "Max Items": "0",
      "Max Weapons": "100",
  ...
  },
  {
    ...
    status: false,
    description:
      "v1.02 (Requires YEP_ItemCore.js) Allow the player to discard\nitems from their inventory.",
    parameters: {
      "---General---": "",
      "Discard Command": "Discard %1 %2/%3",
  ...
  {
    name: "NRP_BattleEventEX",
    status: true,
    description: "v1.041 バトルイベントの機能を拡張します。",
    parameters: { forceValid: "true" },
  },
  {
    name: "SNZ_randomXorshift",
    status: true,
    description:
      "ランダムに何かをする処理の精度を上げます　Xorshiftと呼ばれるアルゴリズムを使用",
    parameters: {},
  },
  {
    name: "FTKR_ItemSubCommand",
    status: true,
    description: "v1.7.3 アイテムボックスにサブコマンドを追加する",
    parameters: {
      "--アイテム情報取得--": "",
      "Use Item Id": "",
      "--サブコマンド--": "",
      "Command List": "use,discard,cancel",
      "Command Position X": "0",
      "Command Position Y": "180",
      "Command Width": "240",
      "Command Height": "-1",
      "--アクター選択画面--": "",
      "Disable Select Single Actor": "0",
      "--使うコマンド--": "",
      "Command Use Format": "Use",
      "--やめるコマンド--": "",
      "Command Cancel Format": "Cancel",
      discard: "",
      "Command Discard Format": "Toss",
      "--数値入力画面--": "",
      "Max Number Format": "/MAX %1",
      "Number Position X": "240",
      "Number Position Y": "180",
      "Number Width": "456",
      "Number Height": "-1",
      "--確認画面--": "",
      "Enable Confirmation": "0",
      "Conf Title Format": "Are you going to throw away [%1] [%2]?",
      "Confirmation Ok Format": "Confirm",
      "Confirmation Cancel Format": "Cancel",
      "--捨てるサウンド--": "",
      "Disposal SE Name": "Decision1",
      "Disposal SE Pitch": "100",
      "Disposal SE Volume": "90",
      equip: "",
      "Command Equip Format": "装備する",
      display_timing_equipstatus: "1",
      Status_Window_Layout:
        '{"posiX":"0","posiY":"180","width":"240","height":"-1"}',
      Select_Default_Param: "8,2,3,4,5,6,7",
      Enabled_Window_Param: "false",
      Status_Window_Param: "",
      Enabled_statusList: "false",
      statusList: "",
      "Actor Status Space In Text": "5",
      "--カスタムコマンド0--": "",
      "Custom0 Format": "",
      "Custom0 EventID": "",
      "Custom0 Show Condition": "",
      "Custom0 Enabled Condition": "",
      "--カスタムコマンド1--": "",
      "Custom1 Format": "",
      "Custom1 EventID": "",
      "Custom1 Show Condition": "",
      "Custom1 Enabled Condition": "",
      "--カスタムコマンド2--": "",
      "Custom2 Format": "",
      "Custom2 EventID": "",
      "Custom2 Show Condition": "",
      "Custom2 Enabled Condition": "",
      "--カスタムコマンド3--": "",
      "Custom3 Format": "",
      "Custom3 EventID": "",
      "Custom3 Show Condition": "",
      "Custom3 Enabled Condition": "",
      "--カスタムコマンド4--": "",
      "Custom4 Format": "",
      "Custom4 EventID": "",
      "Custom4 Show Condition": "",
      "Custom4 Enabled Condition": "",
    },
  },
  {
  ...
  {
    name: "PNDK_LuggageCapacity",
    status: true,
    description:
      "アイテムや武器・防具の所持できる数を重量（ポイント）制にします。",
    parameters: {
      "Carry point": "\\V[21]",
      "Excess handling in EnemyDrop": "Choice",
      "Excess handling in GainItem": "Choice",
      "Default weight": "10",
      Unit: "W",
      "Attribute name": "Weight",
      "Window layout in menu": "Default",
      "Window opacity in menu": "255",
      "Window layout in item": "Default",
      "Window opacity in item": "255",
      "Window layout in shop": "Default",
      "Window opacity in shop": "255",
      "Font color when weight exceeded": "#ff0000",
      "Dialog title": "Overweight!",
      "Dialog message": "Reduce total weight",
    },
  },
  {
    name: "RandomTreasure",
  ...
  {
    name: "BattleLogToMessage",
    status: true,
    description: "バトルログのメッセージ表示プラグイン",
    parameters: {
      ステータス上部配置: "false",
      ポップアップ抑制: "false",
      メッセージ上部配置: "false",
  ...
  {
    name: "cellicom_RarityItemColor",
    status: true,
    description:
      "Change Items and Weapons color based on rarity value in notetag",
    parameters: {
      "Rarity 0": "0",
      "Rarity 1": "4",
      "Rarity 2": "6",
      ...
      "Rarity 4": "3",
      "Rarity 5": "30",
      "Rarity Escape Code": "CR",
      "==YANFLY PATCH==": "",
      YANFLY_SLOT_PATCH: "false",
    },
  },
  {
    name: "BordSkin_edit",
  ...
  {
    name: "Ricon_RandomItemLose",
    status: true,
    description: "アイテムのランダム消失プラグイン",
    parameters: {
      IncludeItems: "true",
      IncludeWeapons: "true",
      IncludeArmors: "true",
      IncludeImportants: "false",
      IncludeEquips: "true",
      MinCount: "1",
      MaxCount: "10",
      VariousItems: "true",
      Message: "Lost %2 %1.",
      Sound: '{"name":"Miss","volume":"90","pitch":"100","pan":"0"}',
    },
  },
  {
    name: "PH_Warehouse",
    ...
    parameters: {
      "---Options---": "",
      "All Together": "0",
      "Stack Item Quantity": "0",
      "---Vocabulary---": "",
      "Withdraw Text": "Withdraw",
      "Deposit Text": "Deposit",
      "All Text": "All",
      "Available Space Text": "Available Space:",
    },
  },
  {
    name: "AltMenuScreen_kytp2_3",
    status: true,
  ...
  },
  {
    ...
    parameters: {
      ...
      "Cursor Overhead Y": "0",
      "Cursor Max Frame": "0",
      "Cursor Frame Spacing": "0",
    },
  },
  {
    name: "PassiveSkill",
    status: true,
    description: "ver1.061/スキルに特徴を設定できるようにします。",
    parameters: { "Passive Skill Type ID": "3", "Add Multi Order": "true" },
  },
  {
    name: "SkillCPSystem",
    status: true,
    description: "ver1.11/スキルを装備して使用するシステムを追加します。",
    parameters: {
      "Default Skill CP": "1",
      "Default Skill Set": "3",
      "Default CP": "5",
      ...
      "CP Gauge Color1": "28",
      "CP Gauge Color2": "29",
      "Add Menu Skill Setting": "false",
      "Menu Skill Setting Title": "スキルセット",
      "Show Unsettable Skill": "true",
      "Unsetting Skill Color": "4",
      "No Cost Class Learn Skills": "false",
      "Simple Mode": "false",
      "Show Skill Cost": "true",
      "CP Cost Color": "21",
      "No Cost Traits Skills": "false",
      "Slot Size": "5",
    },
  },
  {
    name: "TikanEquip",
    status: true,
    description: "ver1.01 一定の装備関係がある場合に装備ごとに効果発動。",
    parameters: {},
  },
  {
    name: "K_MessageWindowAdjust",
    status: true,
    description: "メッセージウィンドウ幅の調整をおこないます。",
    parameters: {},
  },
  {
    name: "AutomaticState",
  ...
  {
    name: "EquipSlotAddTrait",
    status: true,
    description: "ver1.02/装備スロットを追加する特徴を設定できるようにします。",
    parameters: {},
  },
  {
  ...
  },
  {
    ...
    parameters: {
      sbCommandPictures:
        '["{\\"actorId\\":\\"2\\",\\"stateId\\":\\"\\",\\"switchId\\":\\"\\",\\"hpPercentage\\":\\"100\\",\\"imageName\\":\\"bpd\\",\\"origin\\":\\"upperleft\\",\\"x\\":\\"480\\",\\"y\\":\\"30\\",\\"scaleX\\":\\"55\\",\\"scaleY\\":\\"55\\",\\"motion\\":\\"floatrightfast\\"}","{\\"actorId\\":\\"2\\",\\"stateId\\":\\"\\",\\"switchId\\":\\"\\",\\"hpPercentage\\":\\"70\\",\\"imageName\\":\\"bpd2\\",\\"origin\\":\\"upperleft\\",\\"x\\":\\"480\\",\\"y\\":\\"30\\",\\"scaleX\\":\\"55\\",\\"scaleY\\":\\"55\\",\\"motion\\":\\"floatrightfast\\"}","{\\"actorId\\":\\"2\\",\\"stateId\\":\\"\\",\\"switchId\\":\\"\\",\\"hpPercentage\\":\\"40\\",\\"imageName\\":\\"bpd3\\",\\"origin\\":\\"upperleft\\",\\"x\\":\\"480\\",\\"y\\":\\"30\\",\\"scaleX\\":\\"55\\",\\"scaleY\\":\\"55\\",\\"motion\\":\\"floatrightfast\\"}","{\\"actorId\\":\\"2\\",\\"stateId\\":\\"\\",\\"switchId\\":\\"\\",\\"hpPercentage\\":\\"10\\",\\"imageName\\":\\"bpd4\\",\\"origin\\":\\"upperleft\\",\\"x\\":\\"480\\",\\"y\\":\\"30\\",\\"scaleX\\":\\"55\\",\\"scaleY\\":\\"55\\",\\"motion\\":\\"floatrightfast\\"}","{\\"actorId\\":\\"2\\",\\"stateId\\":\\"82\\",\\"switchId\\":\\"\\",\\"hpPercentage\\":\\"100\\",\\"imageName\\":\\"bpd5\\",\\"origin\\":\\"upperleft\\",\\"x\\":\\"478\\",\\"y\\":\\"178\\",\\"scaleX\\":\\"100\\",\\"scaleY\\":\\"100\\",\\"motion\\":\\"floatrightfast\\"}"]',
      sbDamagePictures: "[]",
      sbWinPictures: "[]",
      startActorType: "none",
      winActorType: "none",
  ...
  {
    name: "PANDA_ConvertDataName",
    status: true,
    description:
      "文章中にアイテムやスキル、敵キャラ等の名前やアイコンを表示します。",
    parameters: {},
  },
  {
  ...
  },
  {
    ...
    parameters: {
      ...
      "Cursor Y-Axis": "0",
      "-> Commands <<<<<<<<<<<<<<<<<<<<<<<": "",
      "Command Pos 1": "164,331",
      "Command Pos 2": "151,417",
      "Command Pos 3": "180,488",
  ...
  {
    name: "ChangeOperationToFPSStyle",
    status: true,
    description: "キーの設定をFPS寄りの設定に変更します。",
    parameters: {
      項目名称: "Key Operation",
      "設定名称（通常キー）": "Two Handed",
      "設定名称（FPSキー）": "One Handed",
    },
  },
  {
  ...
  {
    name: "ConditionallyAddEffect",
    status: true,
    description:
      "ver1.04/条件を満たすと発動する追加効果を設定できるようになります。",
    parameters: { "Display Add Effect Text": "null" },
  },
  {
  ...
  },
  {
    ...
    parameters: {
      ...
      "--レイアウト設定--": "",
      statusList:
        '["{\\"text\\":\\"face\\",\\"value\\":\\"\\",\\"x\\":\\"0\\",\\"y\\":\\"8\\",\\"width\\":\\"width\\"}","{\\"text\\":\\"name\\",\\"value\\":\\"\\",\\"x\\":\\"140\\",\\"y\\":\\"0\\",\\"width\\":\\"width-32\\"}","{\\"text\\":\\"state\\",\\"value\\":\\"\\",\\"x\\":\\"0\\",\\"y\\":\\"0\\",\\"width\\":\\"32\\"}","{\\"text\\":\\"hp\\",\\"value\\":\\"\\",\\"x\\":\\"140\\",\\"y\\":\\"32\\",\\"width\\":\\"180\\"}","{\\"text\\":\\"mp\\",\\"value\\":\\"\\",\\"x\\":\\"140\\",\\"y\\":\\"64\\",\\"width\\":\\"180\\"}","{\\"text\\":\\"tp\\",\\"value\\":\\"\\",\\"x\\":\\"140\\",\\"y\\":\\"96\\",\\"width\\":\\"180\\"}","{\\"text\\":\\"text(%1)\\",\\"value\\":\\"\\\\\\\\i[16]\\",\\"x\\":\\"-2\\",\\"y\\":\\"-2\\",\\"width\\":\\"32\\"}"]',
      "Actor Status Space In Text": "5",
      "--ウィンドウ設定--": "",
  ...
  },
  {
    ...
    parameters: {
      ...
      paramName: "",
      "XPARAM Name":
        '{"hit":"Hit","eva":"Evasion","cri":"Crit","cev":"Crit Evasion","mev":"Magic Evasion","mrf":"Magic Reflect","cnt":"Counter","hrg":"HPRegen","mrg":"MPRegen","trg":"TPRegen"}',
      "SPARAM Name":
        '{"tgr":"Target","grd":"Guard","rec":"Recovery","pha":"Medicine","mcr":"MPUse","tcr":"TPCharge","pdr":"DMG","mdr":"Magic DMG","fdr":"Floor DMG","exr":"EXP"}',
    },
  },
  {
    name: "TMLogWindow",
  ...
  },
  {
    ...
    parameters: {
      GlossaryInfo:
        '["{\\"GlossaryType\\":\\"1\\",\\"CommandName\\":\\"\\",\\"UseCategory\\":\\"true\\",\\"CommandSwitchId\\":\\"0\\",\\"BackPicture\\":\\"\\",\\"SelectAction\\":\\"1\\",\\"SelectSwitchId\\":\\"0\\",\\"SelectVariableId\\":\\"0\\",\\"ConfirmMessage\\":\\"false\\",\\"ConfirmUse\\":\\"Use\\",\\"ConfirmNoUse\\":\\"Cancel\\",\\"ConfirmX\\":\\"0\\",\\"ConfirmY\\":\\"0\\",\\"GlossaryHelp\\":\\"\\",\\"CategoryHelp\\":\\"Please select a category.\\",\\"ConfirmHelp\\":\\"\\",\\"UsingHelp\\":\\"\\",\\"CompleteView\\":\\"true\\",\\"CompleteMessage\\":\\"Total: \\\\\\\\c[2]%1\\\\\\\\c[0] ％\\",\\"ShowingItemNumber\\":\\"false\\",\\"UsableDefault\\":\\"true\\",\\"UseItemHistory\\":\\"false\\",\\"GlossaryListWidth\\":\\"240\\",\\"VisibleItemNotYet\\":\\"\\",\\"HideIcon\\":\\"false\\"}"]',
      Layout: "",
      FontSize: "22",

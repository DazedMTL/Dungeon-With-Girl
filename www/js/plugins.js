...
var $plugins = [
  ...
  },
  {
    ...
    parameters: {
      ...
      "Param Text1": ",,無効化",
      "Param Text2":
        "命中率,回避率,会心率,会心回避,魔法回避,魔法反射率,反撃率,再生率,再生率,再生率",
      "Param Text3":
        "狙われ率,,回復効果率,薬の知識,消費率,,物理ダメージ率,魔法ダメージ率,床ダメージ率,経験値獲得率",
      "Param Text4": "攻撃時属性:,攻撃時ステート付与:,攻撃速度,攻撃回数",
      "Param Text5":
        "スキルタイプ追加:,スキルタイプ封印:,スキル追加:,スキル封印:",
      "Param Text6":
        "武器タイプ追加:,防具タイプ追加:,装備固定:,装備封印:,二刀流",
      "Param Text7":
        "行動回数追加,自動戦闘,防御,身代わり,TP持越し,消滅エフェクト,エンカウント半減,エンカウント無効,不意打ち無効,先制率アップ,取得金額倍化,アイテム取得率倍化",
      "Defeat Text": "通常,ボス,瞬間消去,消えない",
      "Effects Names":
  ...
  },
  {
    ...
    parameters: {
      "---General---": "",
      "Discard Command": "捨てる %1 %2/%3",
      "Default Discard": "true",
      "---Confirm---": "",
      "Confirm Discard": "false",
      "Confirm Message": "本当に捨てますか？ %1 %2?",
      "Confirm Yes": "はい",
      "Confirm No": "いいえ",
    },
  },
  ...
  },
  {
    ...
    parameters: {
      ...
      "--使うコマンド--": "",
      "Command Use Format": "使う",
      "--やめるコマンド--": "",
      "Command Cancel Format": "やめる",
      discard: "",
      "Command Discard Format": "捨てる",
      "--数値入力画面--": "",
      ...
      "Conf Title Format": "[%1]を[%2]個 捨てますか？",
  ...
  },
  {
    ...
    parameters: {
      ...
      "Dialog title": "重量オーバーです！",
      "Dialog message": "総重量を減らしてください。",
    },
  },
  {
    name: "RandomTreasure",
